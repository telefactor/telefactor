...
ArgumentError: comparison of String with 0 failed
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam/family/relationship_list.rb:46:in `>='
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam/family/relationship_list.rb:46:in `get_grandparent_names'
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam/family.rb:93:in `get_grandparents'
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam.rb:106:in `get_grandparents'
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam/cli/get.rb:98:in `call'
  ~/.rvm/gems/ruby-2.6.1/gems/hanami-cli-0.3.1/lib/hanami/cli.rb:57:in `call'
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/lib/fam/cli.rb:20:in `call'
  ~/workspace/telefactor-root/telefactor-fam-sourcerer-zero/exe/fam:10:in `<top (required)>'
...

{
  ...
  "relationships": [
    ...
    {
      "child_name": "Homer",
      "parent_name": "Grampa Simpson"
    },
    {
      "child_name": "Grampa Simpson",
      "parent_name": "Smoobles IIIII"
    },
    {
      "child_name": "Smoobles IIIII",
      "parent_name": "Smoobles IIII"
    },
    {
      "child_name": "Smoobles IIII",
      "parent_name": "Smoobles III"
    },
    {
      "child_name": "Smoobles III",
      "parent_name": "Smoobles II"
    },
    {
      "child_name": "Smoobles II",
      "parent_name": "Smoobles I"
    }
  ]
}
```
